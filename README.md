The Scoober game is implemented with Spring Boot and the communication between the two players will happen through the APIs. Each player will be simply a browser.
